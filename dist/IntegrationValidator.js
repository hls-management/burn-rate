...
export class IntegrationValidator {
     ...
     */
    static async testGameEngineCreation() {
     ...
     */
    static async testCLIInterfaceCreation() {
        const testStart = Date.now();
        try {
            const engine = new GameEngine();
     ...
     */
    static async testGameInitialization() {
        const testStart = Date.now();
        try {
     ...
     */
    static async testBasicGameFlow() {
        const testStart = Date.now();
        try {
            const engine = new GameEngine();
     ...
     */
    static async testCommandProcessing() {
        const testStart = Date.now();
        try {
            const engine = new GameEngine();
     ...
     */
    static async testTurnProgression() {
        const testStart = Date.now();
        try {
            const engine = new GameEngine();
     ...
     */
    static async testVictoryConditions() {
        const testStart = Date.now();
        try {
            const engine = new GameEngine();
     ...
     */
    static async testResourceValidation() {
        const testStart = Date.now();
        try {
            const engine = new GameEngine();
            const gameController = new GameController(engine);
     ...
     */
    static async testFleetValidation() {
        const testStart = Date.now();
        try {
            const engine = new GameEngine();
            const gameController = new GameController(engine);
     ...
     */
    static async testEconomicStall() {
        const testStart = Date.now();
        try {
     ...
     */
    static async testInvalidCommands() {
        const testStart = Date.now();
        try {
            const engine = new GameEngine();
            const inputHandler = new InputHandler();
     ...
     */
    static async testFullGameCycle() {
        const testStart = Date.now();
        try {
            const result = await GameInitializer.initializeGame();
            if (!result.isValid) {
     ...
     */
    static async testSystemRecovery() {
        const testStart = Date.now();
        try {
            // Test error recovery
     ...
     */
    static displayResults(results, summary) {
        console.log('\n' + '='.repeat(80));
